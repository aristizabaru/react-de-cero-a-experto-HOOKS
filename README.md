...
El proyecto desarrollado a continuación se explora el concepto de Hooks en general y su aplicación para la creación de componentes de React. Dentro de la configuración y desarrollo del proyecto se usa [Vite](https://vitejs.dev/) como bundler.
